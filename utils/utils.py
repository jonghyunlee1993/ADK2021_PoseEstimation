...
from utils       import cow_data             as cow_data
...
def draw_paint(im, kpts, mapNumber, epoch, model_arch, dataset):
    limbSeq = [[0,1], [1,2], [2,3], [2,6], [2,9], [3,4], [4,5], [6,7], [7,8], [9,10], [9,13], [10,11], [11,12], [13,14], [14,15], [9,16]]
            #      RED           GREEN           RED          YELLOW          YELLOW          PINK          GREEN           RED
    colors = [[000,000,255], [000,255,000], [000,000,255], [255,255,000], [255,255,000], [255,000,255], [000,255,000], [000,000,255],\
              [255,000,000], [255,255,000], [255,000,255], [000,255,000], [000,255,000], [000,000,255], [255,255,000], [255,000,000], [255,000,255]]
            #      BLUE         YELLOW          PINK           GREEN          GREEN           RED           YELLOW          BLUE           PINK
...
def getDataloader(train_dir, val_dir, test_dir, sigma, workers, batch_size):
    train_loader = torch.utils.data.DataLoader(
                                        cow_data.Cow(train_dir, sigma, "train",
                                        Mytransforms.Compose([Mytransforms.TestResized(368),])),
                                        batch_size  = batch_size, shuffle=True,
                                        num_workers = workers, pin_memory=True)

    val_loader   = torch.utils.data.DataLoader(
                                        cow_data.Cow(val_dir, sigma, "val",
                                        Mytransforms.Compose([Mytransforms.TestResized(368),])),
                                        batch_size  = 1, shuffle=False,
                                        num_workers = 1, pin_memory=True)

    test_loader   = torch.utils.data.DataLoader(
                                        cow_data.Cow(test_dir, sigma, "test",
                                        Mytransforms.Compose([Mytransforms.TestResized(368),])),
                                        batch_size  = 1, shuffle=False,
                                        num_workers = 1, pin_memory=True)
...
def printAccuracies(mAP, AP, mPCKh, PCKh, mPCK, PCK, dataset):
    ...
    print("PCKs:  %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%, %2.2f%%"\
        % (PCK[0]*100,PCK[1]*100,PCK[2]*100,PCK[3]*100,PCK[4]*100,PCK[5]*100,PCK[6]*100,PCK[7]*100,PCK[8]*100,PCK[9]*100,PCK[10]*100,\
            PCK[11]*100,PCK[12]*100,PCK[13]*100,PCK[14]*100,PCK[15]*100,PCK[16]*100,PCK[17]*100))
